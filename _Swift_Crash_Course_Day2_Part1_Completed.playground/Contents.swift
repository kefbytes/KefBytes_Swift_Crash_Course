...
if let user = userName {
    print("userName exists so we can proceed to do stuff")
}
/*:
...
class NetworkManager {
    ...
    init() {
        ...
        authToken = "hbjh2b4hv2h3v14jhjv1123vjhvjh"
    }
}
...
rockBand.guitar?.guitarBrand = "Fender"
...
var rgbGreen = RGBColor.Green(0, 255, 0)
...
enum Link: String {
    ...
    case appleDev = "http://developer.apple.com"
}
/*:
