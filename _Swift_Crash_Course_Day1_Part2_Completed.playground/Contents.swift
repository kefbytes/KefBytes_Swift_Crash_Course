...
let songs: [AnyObject] = [Song(nameIn: "Moonshiner", artistIn: "Uncle Tupelo"), Song(nameIn: "16 Days", artistIn: "Whiskeytown"), Song(nameIn: "New Madrid", artistIn: "Uncle Tupelo")]
...
let items: [Any] = ["Anodyne", 1982, Song(nameIn: "We've Been Had", artistIn: "Uncle Tupelo")]
...
let album = (albumName: "Still Feel Gone", releaseDate: 1991)
...
struct Account {
    ...
    var accountPassword = "p@$$w0rd"
    
    // added below under stored properties
    var expirationDate = 2018 {
        // added with observed properties section
        willSet{
            print("expirationDate is getting updated")
        }
    }
    
    // added during lazy stored properties
    lazy var intitialLogin = NSDate()    
    // added with computed properties and then added an observed property
    var credential: String {
        get {
            return "accountName: \(accountName), accountPassword: \(accountPassword)"
        }
    }
    
    // added during type properties section
    static let loginAPI = "https://www.attemptLogin.com"
}
